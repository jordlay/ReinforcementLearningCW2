    ...
    def generateEpisode(self):
        ...
        while not terminal:
            ...
            if self.batch_size < len(self.memory):
                ...
                batch_matrix = np.array(batch_matrix, dtype=object)
                ...
                target_value = self.target_critic(next_states, target_policy_output)

                # QPrime
                y = rewards + (self.gamma * torch.flatten(target_value))       
